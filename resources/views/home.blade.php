...
@section('content')
    ...
    <div class="landing">
        <div class="container">
            <div class="text">
                <h1>Welcome, To MiDo World</h1>
                <p>Here I am gonna share everything about my life. Books I'm reading, Games I'm playing, Stories and Events</p>
            </div>
            <div class="image">
        ...
        <div class="container">
            <div class="box quality">
                <div class="img-holder">
                    <img src="{{ asset('Imgs/features-01.jpg') }}" alt="">
                </div>
                <h2>Quality</h2>
            ...
            <div class="box time">
                <div class="img-holder">
                    <img src="{{ asset('Imgs/features-02.jpg') }}" alt="">
                </div>
                <h2>Time</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
                <a href="#">More</a>
            ...
            <div class="box passion">
                <div class="img-holder">
                    <img src="{{ asset('Imgs/features-03.jpg') }}" alt="">
                </div>
                <h2>Passion</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
                <a href="#">More</a>
    ...
    <div class="videos" id="videos">
        ...
        <div class="container">
            <div class="holder">
                ...
                <div class="preview">
                    <img src="{{ asset('Imgs/video-preview.jpg') }}" alt="">
    ...
    <div class="footer">
        <div class="container">
            <div class="box">
                ...
                <p class="text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus nulla rem, nostrum sunt.</p>
            </div>
            <div class="box">
                <ul class="links">
